          ...
          Expanded(
            child: ListView(
              children: [
                ...
                // V24: New Tools
                _buildToolIcon(ItemType.profileImage, Icons.account_circle, "PFP"),
                _buildToolIcon(ItemType.chart, Icons.bar_chart, "CHART"),
                _buildToolIcon(ItemType.toggle, Icons.toggle_on, "TOGGLE"),
                _buildToolIcon(ItemType.table, Icons.table_chart, "TABLE"),
                _buildToolIcon(ItemType.pricingCard, Icons.local_offer, "PRICE"),
                _buildToolIcon(ItemType.sidebar, Icons.vertical_split, "SIDEBAR"),
                _buildToolIcon(ItemType.article, Icons.article, "ARTICLE"),
                _buildToolIcon(ItemType.gallery, Icons.grid_view, "GALLERY"),
              ],
            ),
          ),
        ],
